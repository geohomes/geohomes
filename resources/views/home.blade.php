                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="section-tittle mb-100">
                            <span class="element"  style="background-color: #0EA15F!important">From News</span>
                            <h2  style="color: black!important">News & Media center</h2>
                            <p  style="color: black!important">We collect and analyze information about your general usage of the website products services and courses.</p>
                            <a href="{{route('blog')}}" class="all-btn"  style="color: black!important">View All</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
