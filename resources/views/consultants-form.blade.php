...
<body>
  ...
  <!-- Global Banner -->
    <section class="global-banner">
       <img src="/assets/img/materials/consultants-banner.jpg" alt="">
        <h2 class="container">Consultant Form</h2>
    </section>
    <!-- Global Banner End -->

    <div class="application-form">
      <h3 class="mb-3" style="background-color: black;">Become a consultant with us</h3>
    </div>
              <div class="container">
                <div class="row">
