...
<body>
  ...
  <!-- Global Banner -->
    <section class="global-banner">
       <img src="/assets/img/materials/property-banner.jpg" alt="">
        <h2 class="container">Welcome To PSR Page</h2>
    </section>
    <!-- Global Banner End -->

    <form class="application-form">
      <h3 class="mb-3" style="background-color: black;">PROPERTY SEARCH REQUEST (PSR) FORM<br>Kindly fill out the form with the correct details.</h3>
