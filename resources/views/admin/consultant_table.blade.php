         ...
         <!-- it gives feedback messages -->
           ...
           <p style="color:#0EA10F; font-weight: bold">{{$message}}</p>
            ...
            @endif
             ...
             <div class="row">
               <div class="col-12">
                 <h6 class="contact-title " style="color:black;">Consultant Table</h6>
                </div>
               </div>
          ...
          <div class="card-body">
            ...
            <div>
           <a value="{{$row['id']}}" name="{{$row['id']}}" class=" btn " style="background-color:#0EA15F;color: black;" href="viewconsultant/{{$row['id']}}" >view detail</a></div>
            </div>

            <div class="row">
          <div class="col-lg-6 col-sm-6 col-md-6">
          <a class=" btn btn-success" href="editconsultant/{{$row['id']}}" name="{{$row['id']}}" >Edit</a>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6">
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-contact contact_form" action="consultants/{{$row['id']}}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
