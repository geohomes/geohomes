@include('adminLayout.header');
 ...
 <div class="container-fluid py-4">
      <div class="row">
         ...
         <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title mt-30 padding-40" style="color:#0EA15F">About Us Page</h2>
                    </div>
                       <!-- it gives feedback messages -->
                        ...
                        <form class="form-contact contact_form" action="{{route('addabout')}}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
