            ...
            <!-- feedback message ends here -->
             ...
             @if(empty($array))
                      <div class="alert alert-danger col-lg-4">
                        <strong style="color: black;">No Data Available.</strong>
                      </div>
                     @else
       <div class="row">
               <div class="col-12">
                 <h6 class="contact-title " style="color:black;">Affiliate Table</h6>
                </div>
               </div>
          ...
          <div class="card-body">
            <h5 class="card-title">Email:{{$row[ 'email' ] }}</h6>
              <h6 class="card-title">Mobile: {{$row[ 'phone' ] }}</h6>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-contact contact_form" action="affiliate/{{$row['id']}}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
