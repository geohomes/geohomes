...
<title>GeoHomes | Update Logistic Page</title>
</head>
...
<body>
 ...
 <div class="container-fluid py-4">
      <div class="row">
         ...
         <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title mt-30 padding-40" style="color:#0EA15F">Update Logistic Page</h2>
                    </div>
                        ...
                        <form class="form-contact contact_form" action="#" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input required=""class="form-control valid" name="third_image" id="name" type="file" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Upload Second image'" placeholder="{{$row['third_image']}}">
                                        <small class="text-danger">{{$errors->first('third_image') }}</small>
                                    </div>
                                </div>
