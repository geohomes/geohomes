...
<title>GeoHomes | Update CIS</title>
</head>
...
<body>
   @include('./updatelayout.navbar')
        ...
        <div class="container">
                 <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title mt-30 padding-40" style="color:#0EA15F">Update Client Detail</h2>
                    </div>
                  </div>
                               ...
                               @foreach($cis as $row)
                                  <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                        <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" placeholder="{{$row['fullname']}}">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="occupation" id="address" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Occupation'" placeholder="{{$row['occupation']}}">
                                       <small class="text-danger">{{$errors->first('occupation') }}</small>
                                    </div>
                                </div>
                                    <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="date_of_birth" id="date_of_birth" type="date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Date Of Birth'" placeholder="{{$row['DOB']}}">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="lifted" id="lifted" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Lifted'" placeholder="{{$row['lifted']}}">
                                 ...
                                 <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="agent_name" id="agent_name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'agent name'" placeholder="{{$row['agent_name']}}" >
                                       <small class="text-danger">{{$errors->first('agent_name') }}</small>
                                    </div>
                                </div>
                                 <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="agent_phone" id="amount" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'agent phone'" placeholder="{{$row['agent_phone']}}" >
                                       <small class="text-danger">{{$errors->first('agent_phone') }}</small>
                                    </div>
                                </div>
                                 <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="agent_address" id="agent_address" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Agent Address'" placeholder="{{$row['agent_address']}} " >
                                       <small class="text-danger">{{$errors->first('agent_address') }}</small>
                                    </div>
                                </div>
                                 <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="agent_occupation" id="agent_occupation" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'agent occupation'" placeholder="{{$row['agent_occupation']}}" >
                                       <small class="text-danger">{{$errors->first('agent_occupation') }}</small>
                                    </div>
                                </div>
                                 <div class="col-sm-6 col-md-6 col-lg-4 ">
                                    <div class="form-group">
                                       <input class="form-control valid" name="agent_office" id="agent office" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'agent office'" placeholder="{{$row['agent-office_address']}}" >
