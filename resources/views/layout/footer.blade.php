 <footer>
            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-5">
                        <div class="single-footer-caption mt-20 mb-50">
    ...
    <!-- Scroll Up -->
    <div id="back-top" >
        <a title="Go to Top" href="#"> <i style="color: #0EA15F;" class="fas fa-level-up-alt"></i></a>
    </div>
